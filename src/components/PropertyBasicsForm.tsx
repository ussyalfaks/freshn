      ...
      <form>
        <div className="space-y-6">
          <div>
            ...
            <input
              className="w-full bg-[#F9F9F9] p-4 border rounded-lg"
          ...
          <div>
            ...
            <select className="w-full p-4 bg-[#F9F9F9] border rounded-lg">
              <option value="" disabled selected >Type in property type</option>
          ...
          <div>
            ...
            <input
              className="w-full p-4 bg-[#F9F9F9] border rounded-lg"
          ...
          <div>
            ...
            <select className="w-full p-4 bg-[#F9F9F9] border rounded-lg">
              <option value="" disabled selected >Type in number of guests</option>
              {[1, 2, 3, 4, 5, 6].map(num => (
          ...
          <div>
            ...
            <select className="w-full p-4 bg-[#F9F9F9] border rounded-lg">
              <option value="" disabled selected >Type in number of bedrooms</option>
              {[1, 2, 3, 4, 5].map(num => (
                <option key={num} value={num}>{num}</option>
              ))}
            </select>
          ...
          <div>
            ...
            <select className="w-full p-4 bg-[#F9F9F9] border rounded-lg">
              <option value="" disabled selected >Type in number of bathrooms</option>
              {[1, 2, 3, 4, 5].map(num => (
                <option key={num} value={num}>{num}</option>
              ))}
            </select>
