  ...
  return (
    ...
    <div className="max-w-7xl mx-auto px-2 py-6">
       <div className="mb-6 flex flex-col">
         ...
         <h1 className="text-[1rem] md:text-3xl font-bold my-2">3-Bedroom Around Barnawa GRA</h1>
         </div>
         <div className="flex flex-wrap text-sm md:text-lg items-center my-4 text-secondary">
           <Star className="w-4 mb-2 h-4 fill-current text-blue-400 mr-1" />
           <span className="mr-2 mb-2">4.84</span>
           <span className="mr-2 mb-2 bg-gray-300 w-1 h-1 rounded-[1px]"></span>
           ...
           <MapPin className='mr-1 w-4 h-4 text-slate-600'/> Barnawa, <strong>Kaduna</strong>
           </span>
         </div>
       </div>
        ...
        <div className="flex-grow pr-9">
          <div className="flex justify-between items-start mb-6">
            <div className="flex items-center mb-6">
              ...
              <div>
                <h2 className="text-xl md:text-2xl font-semibold">Hosted by Helen</h2>
          ...
          {/* Features section */}
          <div className="grid grid-cols-2 md:w-11/12 md:grid-cols-3 md:space-x-4 mb-4 w-full">
           ...
           <span className="text-secondary">44 reviews</span>
            ...
            <div className="grid grid-cols-5 items-center justify-center gap-2 mb-4">
              <div className="border col-span-2 flex flex-col rounded p-2">
                <div className="text-xs md:text-sm my-2 font-semibold">CHECK-IN</div>
                <div className='my-1 text-xs md:text-sm'>7th Aug 2024</div>
              </div>
              <div className="bg-gray-300 w-2 h-2 rounded-[1px] mx-auto"></div>
              <div className="border col-span-2 flex flex-col rounded p-2">
                <div className="text-xs md:text-sm my-2 font-semibold">CHECK-OUT</div>
                <div className='my-1 text-xs md:text-sm'>9th Aug 2024</div>
              </div>
            </div>
            <div className='my-5'>
